package top.freshgeek.springcloud.common;
...
public interface MiscroServiceNameConstants {
    ...
    String STORAGE_SERVICE = "seata-storage-service";
    String ACCOUNT_SERVICE = "seata-account-service";
    String ORDER_SERVICE = "seata-order-service";
}
